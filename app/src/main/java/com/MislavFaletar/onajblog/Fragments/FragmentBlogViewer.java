...
public class FragmentBlogViewer extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.blog_viewer_fragment, container, false);
        return view;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mTextViewTitle = view.findViewById(R.id.blogViewerTitle);
        mTextViewContent = view.findViewById(R.id.blogViewerContent);
        mImageViewImg = view.findViewById(R.id.blogViewerImg);
